            ...
            <div>
                ...
                <ul style="list-style:none;padding:0;margin:0;">
                    ...
                    <li style="margin-bottom:18px;display:flex;align-items:flex-start;gap:12px;">
                        ...
                        <div>
                            <a href="https://wa.me/{{ $siteSettings['whatsapp_number'] ?? '919876543210' }}?text=Hi%20I%20want%20a%20Betting%20ID" target="_blank" rel="noopener noreferrer" style="color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;">+91 98765 43210</a>
