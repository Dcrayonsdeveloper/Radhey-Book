    ...
    <nav style="max-width:1280px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;padding:12px 20px;">
        ...
        <ul id="nav-menu" style="display:flex;list-style:none;align-items:center;gap:5px;margin:0;padding:0;">
            ...
            <li style="margin-left:10px;">
                <a href="https://linktr.ee/radheybook" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,#d4af37,#f5d060);color:#1a1a2e;text-decoration:none;font-size:14px;font-weight:700;padding:10px 22px;border-radius:50px;transition:all 0.3s ease;box-shadow:0 4px 15px rgba(212,175,55,0.3);">
    ...
    <div id="mobile-nav" style="display:none;background:linear-gradient(135deg,#0a0a1a,#1a1a2e);padding:20px;border-top:1px solid rgba(212,175,55,0.2);">
        <ul style="list-style:none;padding:0;margin:0;">
            ...
            <li style="padding:16px 0 0;">
                <a href="https://linktr.ee/radheybook" target="_blank" rel="noopener noreferrer" style="display:flex;align-items:center;justify-content:center;gap:10px;background:linear-gradient(135deg,#d4af37,#f5d060);color:#1a1a2e;text-decoration:none;font-size:15px;font-weight:700;padding:14px;border-radius:50px;text-align:center;">
