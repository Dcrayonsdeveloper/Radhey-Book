    ...
    <div class="container">
        ...
        <div class="faq-list" style="max-width: 800px; margin: 0 auto;">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>{!! $page->section('faq_3_a', 'Contact us on WhatsApp at +91 98765 43210 and request a password reset. We will verify your identity and provide you with a new password within minutes. You can then change it to something of your choice.') !!}</p>
                </div>
            </div>
            <div class="faq-item">
                <div class="faq-question">
...
<section class="section" id="cta">
    <div class="container">
        ...
        <div class="text-center" style="margin-top: 15px;">
            <p style="opacity: 0.7;">{!! $page->section('cta_contact_text', 'Or call us at <a href="tel:+' . ($siteSettings['whatsapp_number'] ?? '919876543210') . '" class="text-gold">+91 98765 43210</a> | Email: <a href="mailto:support@radheybettingid.com" class="text-gold">support@radheybettingid.com</a>') !!}</p>
        </div>
    </div>
</section>
