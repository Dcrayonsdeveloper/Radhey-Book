    ...
    <div class="container">
        ...
        <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;">
            ...
            <div style="flex:1;min-width:300px;max-width:500px;">
                <img src="{{ asset('images/lords exchange.png') }}" alt="Lords Exchange ID" style="width:100%;border-radius:16px;" loading="lazy" decoding="async">
            </div>
        </div>
    </div>
</section>
...
<section class="section section-alt" id="what-is">
    <div class="container">
        ...
        <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;">
            <div style="flex:1;min-width:300px;max-width:500px;">
                <img src="{{ asset('images/cricket.png') }}" alt="Lords Exchange Betting" style="width:100%;border-radius:16px;" loading="lazy" decoding="async">
            </div>
            <div style="flex:1;min-width:300px;">
                <div class="content-block">
