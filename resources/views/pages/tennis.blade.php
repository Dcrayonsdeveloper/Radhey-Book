    ...
    <div class="container">
        ...
        <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;">
            ...
            <div style="flex:1;min-width:300px;max-width:500px;">
                <img src="{{ asset('images/TENNIS FOOTBALL AVIATOR/tennis_1.png') }}" alt="Tennis Betting ID" style="width:100%;border-radius:16px;" onerror="this.src='{{ asset('images/tennis.png') }}'">
            </div>
        </div>
    </div>
</section>
...
<section class="section section-alt" id="what-is">
    <div class="container">
        ...
        <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;">
            <div style="flex:1;min-width:300px;max-width:500px;">
                <img src="{{ asset('images/TENNIS FOOTBALL AVIATOR/tennis_banner_2.png') }}" alt="Tennis Betting" style="width:100%;border-radius:16px;" onerror="this.src='{{ asset('images/tennis.png') }}'">
            </div>
            <div style="flex:1;min-width:300px;">
                <div class="content-block">
