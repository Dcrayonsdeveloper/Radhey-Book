    ...
    <div class="container">
        <div style="max-width: 900px; margin: 0 auto;">
            ...
            <div class="feature-card" style="margin-bottom: 30px;">
                ...
                <ul style="margin-top: 10px; padding-left: 20px; line-height: 2;">
                    <li>{!! $page->section('contact_text_2', 'WhatsApp: <a href="https://wa.me/' . ($siteSettings['whatsapp_number'] ?? '919876543210') . '" class="text-gold">+91 98765 43210</a>') !!}</li>
                    <li>{!! $page->section('contact_text_3', 'Phone: <a href="tel:+' . ($siteSettings['whatsapp_number'] ?? '919876543210') . '" class="text-gold">+91 98765 43210</a>') !!}</li>
...
<section class="section" id="cta" style="background: linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 50%, #0a0a1a 100%);">
    <div class="container">
        ...
        <div class="text-center">
            <a href="https://wa.me/{{ $siteSettings['whatsapp_number'] ?? '919876543210' }}?text=Hi%20I%20have%20a%20question%20about%20terms" class="btn btn-gold btn-lg" target="_blank" rel="noopener">
