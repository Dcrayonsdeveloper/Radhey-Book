...
@php
    $waLink = 'https://wa.me/' . ($siteSettings['whatsapp_number'] ?? '919876543210') . '?text=Hi%20I%20want%20a%20Lotus%20Exchange%20ID';
@endphp
    ...
    <div class="container">
        ...
        <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;">
            ...
            <div style="flex:1;min-width:300px;max-width:500px;">
                <img src="{{ asset('images/lotus exchange.png') }}" alt="Lotus Exchange ID" style="width:100%;border-radius:16px;">
            </div>
        </div>
    </div>
</section>
...
<section class="section section-alt" id="what-is">
    <div class="container">
        ...
        <div style="display:flex;align-items:center;gap:40px;flex-wrap:wrap;">
            <div style="flex:1;min-width:300px;max-width:500px;">
                <img src="{{ asset('images/casino.png') }}" alt="Lotus Exchange Betting" style="width:100%;border-radius:16px;">
            </div>
            <div style="flex:1;min-width:300px;">
                <div class="content-block">
