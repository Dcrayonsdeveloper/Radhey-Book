...
<section class="hero-section" id="hero">
    ...
    <div class="hero-content container">
        ...
        <div class="hero-cta">
            ...
            <a href="tel:+{{ $siteSettings['whatsapp_number'] ?? '919876543210' }}" class="btn btn-outline-gold btn-lg">{!! $page->section('hero_btn2_text', 'Call Us Now') !!}</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="features-grid stats-grid">
            <div class="feature-card" style="text-align: center; display: flex; flex-direction: column; align-items: center;">
                ...
                <p style="font-size: 1.1em; font-weight: 600; color: #d4af37;">{!! $page->section('contact_1_number', '+91 98765 43210') !!}</p>
                ...
                <a href="https://wa.me/{{ $siteSettings['whatsapp_number'] ?? '919876543210' }}?text=Hi%20I%20want%20a%20Betting%20ID" class="btn btn-gold" target="_blank" rel="noopener" style="margin-top: auto; padding-top: 10px;">{!! $page->section('contact_1_btn_text', 'Message Now') !!}</a>
            </div>
            <div class="feature-card" style="text-align: center; display: flex; flex-direction: column; align-items: center;">
                <div class="feature-icon" style="margin: 0 auto 20px;">
                ...
                <p style="font-size: 1.1em; font-weight: 600; color: #d4af37;">{!! $page->section('contact_2_number', '+91 98765 43210') !!}</p>
        ...
        <div class="faq-list" style="max-width: 800px; margin: 0 auto;">
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>{!! $page->section('faq_1_a', 'The fastest way to reach us is through WhatsApp at +91 98765 43210. Whether you want an IPL betting ID, a cricket betting ID or help with login, our team responds instantly 24/7. You can also call us directly on the same number.') !!}</p>
                </div>
            </div>
            <div class="faq-item">
                <div class="faq-question">
...
<section class="section" id="cta" style="background: linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 50%, #0a0a1a 100%);">
    <div class="container">
        ...
        <div class="text-center" style="margin-top: 15px;">
            <p style="opacity: 0.7;">{!! $page->section('cta_footer_text', 'Or call us at <a href="tel:+919876543210" class="text-gold">+91 98765 43210</a> | Email: <a href="mailto:support@radheybettingid.com" class="text-gold">support@radheybettingid.com</a>') !!}</p>
        </div>
    </div>
</section>
