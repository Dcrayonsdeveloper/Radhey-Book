...
<body>
    ...
    <div class="sticky-cta-bar">
        <div class="sticky-cta-inner">
            <a href="https://linktr.ee/radheybook" class="btn btn-gold" target="_blank" rel="noopener">
    ...
    <div id="bonus-timer">
        ...
        <a href="https://linktr.ee/radheybook" target="_blank" rel="noopener" class="bt-claim">Claim Now</a>
    </div>
    <style>
    ...
    <script>
        (function() {
            var waUrl = 'https://linktr.ee/radheybook';
